...
export const faqData: FAQItem[] = [
  ...
  {
    question: '通信障害や停電、鍵が開かない等の緊急トラブル対策・防犯はどうなっていますか？',
    answer: '大手SIerでのシステム設計思想を導入し、通信障害時でもローカル認証（オフライン）で解錠できるバックアップ機構、遠隔リブート機能、24時間駆けつけ可能な物理解錠キーボックスの設置など、多層的な安全対策・冗長化をあらかじめ設計します。また、現場オペレーション用の防犯・緊急トラブルシューティングマニュアルも提供します。'
  },
  {
  ...
  {
    question: '中小企業省力化投資補助金やIT導入補助金の活用相談はできますか？',
    answer: 'はい、「中小企業省力化投資補助金」や「IT導入補助金」などの公的支援を活用した無人化・省人化システムの導入計画についてご相談が可能です。要件適合や投資対効果を最大化するシステム設計をご提案いたします。'
  }
];
